define(['angular', 'angularAMD', 'angular-moment','angular-ui-router', 'ui-bootstrap','angular-animate','angular-file-upload','angular-img-crop','angular-tag','angular-ui-calendar','angular-xeditable','angular-chart','angular-post-message'], function (angular, angularAMD) {
            ...
            .state('root',{
                ...
                views: {
                    'header': angularAMD.route({
                        templateUrl: '/public/dist/js/app/template/header-customer.tpl.html',
    ...
    var app = angular.module("smartCrmApp", ['angularMoment','ui.router','ui.bootstrap','ngAnimate','angularFileUpload','ngImgCrop','ngTagsInput','ui.calendar','xeditable','chart.js','ngPostMessage']);
